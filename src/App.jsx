...
// ─── DATABASE — ~1000 parole italiane da 5 lettere ───────────────────────────
const DB_RAW = [
  // A
  ...
  "ARSIA","ANCORA","ANIME","ALOSA","ARARE",
  // B
  ...
  "BANCO","BANDO","BARCO","BEFFA","BERCO","BERTO","BINGO","BIOTA","BISSO","BOFFA",
  // C
  ...
  "CESTA","CESTO","CHINA","CIGNO","CIMBA","CIPPO","CIRRO","CLAVA","CLERO","CLIMA",
  "CLONE","CLORO","COCCO","COEVO","COFFA","COMBO","CONCA","CONTA","CONTE","COPIA",
  "COPPA","COPPO","CORNO","CORVO","COSCA","COSTA","COSTO","COZZO","CRASI","CRAVO",
  "CRINI","CRIVO","CROMA","CROMO","CRONO","CRUDA","CRUDO","CUBIA","CULEO","CULMO",
  "CUNEO","CURDO","CURIO","COLTO","COLAO","COVIO","CORMO","CORRO","CORBO","COFRA",
  // D
  "DANNO","DANZA","DARDO","DENTE","DOSSO","DRAGO","DUOMO","DAINO","DAMMA","DEBOL",
  "DENSO","DISCO","DIODO","DOCCE","DOGMA","DOLCE","DOLMO","DOMBO","DORSO","DRENA",
  "DRITTA","DROGA","DUOLO","DUPLO","DACCA","DALMO","DAMPA","DARIA","DARMO","DAURO",
  "DECIO","DEDAL","DELTO","DEMIO","DESCA","DISMO","DIPTA","DIROM","DITTO","DOCMA",
  "DOLCO","DOLSO","DONTE","DORMO","DOSIO","DRESS","DUONA","DUONI","DUTTO",
  // E
  ...
  "ETILE","EVASO","EVOCA","ELOCO","EROTO","ESOSA",
  // F
  ...
  "FECAL","FERMA","FERMO","FERSA","FETIO","FIABA","FIAMO","FIBIO","FIENO","FIGRA",
  "FILMA","FIOCO","FISIO","FITIO","FLATO","FLEBO","FLEMA","FLORA","FOCIO","FOGNA",
  "FONDI","FONDO","FORCO","FORTE","FOSIA","FOTIO","FRAGA","FRANA","FRATE","FRODE",
  "FUGHE","FUGIO","FULCO","FULGA","FUMIO","FURAO","FABIO","FADIO","FAGIO","FALLO",
  "FANNO","FAONA","FARNE","FATTA","FEBIO","FERIO","FERVO","FERZO","FETTO","FIATA",
  "FIGLIO","FILAO","FINCA","FINGO","FIRMO","FISTO","FIUMA","FIUSA","FLOCA","FLORE",
  "FLUTO","FOLIO","FOLMO","FONGA","FORMO","FORTO","FOSIO","FREMA","FRIGO","FRISE",
  "FROLA","FROME","FRONO","FROSA","FRAVO","FULBE",
  // G
  ...
  "GUATA","GUBIA","GUIDA","GENNA","GENOA","GERSA","GILIO","GILDO","GIRON","GIUME",
  "GLOMO","GOLMO","GONDA","GORIA","GRASA","GREMO","GRESA","GRIGO","GRILE","GRIMA",
  "GRIPO","GRISA","GRISO","GRITA","GRONA","GROPO","GROSA","GROTO","GRUNA","GUIZO",
  // I
  "IDOLO","INDIA","IRONIA","ISOLA","ICONA","IGLOO","IMAGO","INCIO","INDIO","INNO",
  "INVIO","IODIO","IRIDE","IRIDO","IRISO","IROSO","ISTMO","ITURA","IMELO","IMIDE",
  "IMIDO","IMOLO","IPPIE","IPSIA","ISARD","ISCIO",
  // L
  ...
  "LANIA","LANNA","LAPPA","LAPSO","LARGO","LARMO","LASCE","LASCA","LASMA","LAUTO",
  "LAVRA","LAZIO","LECCO","LEGNO","LEMMA","LENTO","LERMA","LEUCA","LEVIO","LIBIA",
  "LIBIO","LIBRA","LIGIO","LIGNA","LIGNO","LILAC","LILLA","LIMAO","LIMBE","LIMIO",
  "LIMMA","LINCO","LINGO","LINIO","LINZA","LIOMA","LIRIO","LISCA","LISCO","LISIA",
  "LISIO","LISME","LISSO","LITIO","LIUTO","LIVIO","LIVRO","LOBIO","LOGIO","LOGRO",
  "LOMBA","LOMBO","LONCO","LONDO","LONZA","LOPPA","LORDO","LOSCA","LOSCO","LOTTO",
  "LUCCA","LUCIO","LUGRO","LUMIA","LUMBO","LUMEN","LUNGA","LUNGO","LURCO","LURDO",
  // M
  ...
  "MURZA","MUSCO","MUSEO","MUSIO","MUSSA","MUSSO","MALSA","MAMBO","MANIO","MARCO",
  // N
  ...
  "OVAIA","OBELO","OCHIO","OFFIO","OFICO","OLSIO","OLZIO","OMASO","OMINA","OMINO",
  "OMISA","OMISO","ONCIO","ONDIO","ONFIO","OPACA","OPACO","OPPIO","ORBIO","ORDIO",
  "ORGIO","ORIGO","ORSIA","ORUBA","ORUCA","ORUGA","ORULO","OSARO","OSCIA","OSIMO",
  "OSMIO","OSTIO","OUTRO",
  // P
  ...
  "PURSA","PURSO","PUSCA","PUSCO","PIAMO","PIATO","PICIO","PILAO","FINCA","PATEO",
  // R
  ...
  "RAGNO","RANZO","RAPCO","RASPA","RASPO","RAZCO","REDIA","REMCO","REZIA","RIBCO",
  "RICMA","RIGMO","RIGNO","RILMO","RILSA","RIMCO","RIMMA","RINCO","RINSA","RINZA",
  "RISIO","RIVCO","RIVMA","ROMCO","ROMMA","ROMSA","ROPSA","RORCA","ROSIO","ROTIO",
  "ROVIO","RUGMA","RUGNA","RUGSA","RULSA","RUMCO","RUMMA","RURBA","RURCO","RURSA",
  // S
  "SACRO","SAGRA","SALMO","SALTO","SALVO","SASSO","SCALA","SCENA","SCOPA","SCOPO",
  "SCUDO","SENSO","SERVO","SFERA","SOGNO","SOLCO","SORTE","SOTTO","SPADA","SPIGA",
  "STORIA","SUOLO","SUONO","SABCO","SABMO","SACCA","SACCO","SADIA","SAGIO","SALIO",
  "SALLO","SALSA","SALSO","SAMBA","SANBO","SANCA","SANCO","SANGO","SANNA","SANNO",
  "SANSA","SANSO","SANTO","SANZA","SAPCO","SAPPE","SAPPO","SARCO","SARIO","SARMA",
  "SARMO","SARPA","SARPO","SARSA","SARSO","SARTO","SAVIA","SAVIO","SECCO","SEDIA",
  "SEGNO","SELIO","SELLO","SELSA","SEMMA","SEMSO","SENNA","SENNO","SESTO","SFIDA",
  "SFOGO","SFUGA","SIENA","SILCO","SILEO","SILIO","SILVA","SIMBA","SIMIO","SINCO",
  "SINGA","SINGO","SINNA","SINNO","SINSA","SINTO","SINZA","SIPMA","SIPMO","SIRCO",
  "SIRIO","SIRSA","SIRSO","SIRTO","SISCA","SISMA","SISSO","SISTO","SITIO","SITMA",
  "SITMO","SITSA","SLOGA","SLOGO","SNODA","SNODO","SOBBA","SOBBO","SODIO","SOLIO",
  "SOLLO","SOLMA","SOLMO","SOLSA","SOLSO","SOLZA","SOMBA","SOMBO","SOMMA","SOMMO",
  "SONCA","SONCO","SONGA","SONGO","SONNA","SONNO","SONTO","SONZA","SOPRA","SORBA",
  "SORBO","SORDA","SORDO","SORGA","SORGO","SORIA","SORMO","SORSA","SORSO","SORTO",
  "SOSCO","SOSSE","SOSSO","SOVCO","STAMO","STARE","STATO","STECO","STELO","STILE",
  "STIMA","STIMO","STIPA","STIPO","STIVA","STOLA","STONA","STOPA","STRIA","STUFA",
  "STUFO","SULCA","SULCO","SULLA","SULLO","SURCO","SURIA","SURIO","SURSA","SURSO",
  "SUSCA","SUSIO","SUSSO","SVAGO","SVELA","SVELO","SVEVA","SVEVO","SABBA","SALSO",
  "SCAMA","SCAMO","SCAPI","SCAPO","SCARO","SCASO","SCATO","SCAVO","SCELGO","SCEMO",
  "SCENA","SCESO","SCHIFA","SCHIVO","SCOLA","SCONO","SCOPA","SCOPO","SCORI","SCORO",
  "SCOSA","SCOSO","SCOTO","SCOVA","SCRIVO","SCUDA","SCUDO","SECCO","SENCO","SERVO",
  "SESIO","SIMCO","SIMMA","SIPCO","SIRMA","SIRMO","SISIO","SISMO","SITCO","SITSO",
  "SOBCA","SOBCO","SOBIO","SOMCA","SOMCO","SOMIA","SONSA","SONSO","SOPCO","SOPIO",
  "SORCO","SORMA","SORIA","SOSTO","SOTCO","SOTIO","SOTMA","SOTSO","STIGA","STIGO",
  "STIRPE","STIVO","STOLO","STONO","STOPO","STORO","STOSA","STOSO","STOTO","STOVA",
  "STRAO","STRIO","STUMA","STUMO","STUPO","SUBCO","SUBMA","SUBMO","SULMA","SULMO",
  "SULSA","SULSO","SUMBA","SUMBO","SUMCA","SUMCO","SUMIA","SUMSA","SURMA","SURMO",
  "SURTO","SURZA","SUSCO","SUSMA","SUSMO","SUSTO","SVEMA","SVEMO","SVESA","SVESO",
  // T
  ...
  "TREPA","TRESA","TRESO","TRETO","TREVO","TRIGI","TRINO","TRIOA","TULCA","TULCO",
  "TULIO","TULLA","TULLO","TULMA","TULMO","TULSA","TULSO","TUMBA","TUMBO","TUMCA",
  "TUMCO","TUMIA","TUMIO","TUMMA","TUMMO","TUMPA","TUNCA","TUNCO","TUNDA","TUNDO",
  "TUNGA","TUNGO","TUNNA","TUNNO","TUNSA","TUNTO","TUNZA","TURBA","TURBO","TURCA",
  "TURCO","TURDA","TURDO","TURGA","TURGO","TURIA","TURIO","TURMA","TURMO","TURNA",
  "TURNO","TURRA","TURSA","TURSO","TURTO","TURZA","TUSCA","TUSCO","TUSIO","TUSMA",
  "TUSMO","TUSSA","TUSSO","TUSTO","TITMO","TITSA","TITCO","TITIO","TITMA","TITTO",
  // U
...
:root{--bg:#121213;--surface:#1a1a1b;--border:#3a3a3c;--text:#fff;--muted:#818384;
...
.header{width:100%;max-width:500px;display:flex;align-items:center;justify-content:space-between;
  padding:12px 16px;border-bottom:1px solid var(--border);}
.header-title{font-family:'Bebas Neue',sans-serif;font-size:28px;letter-spacing:4px}
.wordle-num{font-size:11px;color:var(--muted);font-family:'Bebas Neue',sans-serif;letter-spacing:1px}
.icon-btn{background:none;border:none;cursor:pointer;color:var(--muted);font-size:20px;padding:4px;transition:color .2s}
.icon-btn:hover{color:var(--text)}
.header-btns{display:flex;gap:8px}

.toast-container{position:fixed;top:70px;left:50%;transform:translateX(-50%);
  display:flex;flex-direction:column;align-items:center;gap:8px;z-index:100;pointer-events:none;}
.toast{background:var(--text);color:var(--bg);font-weight:700;font-size:14px;
  padding:10px 18px;border-radius:6px;animation:fadeIn .2s ease both;}

.board-wrap{flex:1;display:flex;flex-direction:column;align-items:center;padding:16px 0 8px}
...
/* Cella base */
.cell{width:62px;height:62px;position:relative}
.cell-face{
...
/* Con lettera digitata */
.cell.filled .cell-face{border-color:#565758;animation:pop .1s ease}
/* Già rivelata (statica) */
.cell.revealed .cell-face{background:var(--status);border-color:var(--status);color:#fff}

/* Flip fase 1: scende */
.cell.flip-down .cell-face{
  animation:flipDown .15s ease calc(var(--col) * 0.1s) both;
}
/* Flip fase 2: risale con colore */
.cell.flip-up .cell-face{
  background:var(--status);border-color:var(--status);color:#fff;
  transform:rotateX(-90deg);
  animation:flipUp .15s ease calc(var(--col) * 0.1s) both;
}

.keyboard{width:100%;max-width:500px;padding:0 8px 16px;display:flex;flex-direction:column;gap:8px}
.kb-row{display:flex;justify-content:center;gap:6px}
.kb-key{height:58px;min-width:43px;max-width:43px;flex:1;border-radius:4px;border:none;
  background:#818384;color:#fff;font-family:'Inter',sans-serif;font-size:13px;font-weight:700;
  cursor:pointer;transition:background .3s,transform .1s;user-select:none;}
.kb-key.wide{min-width:65px;max-width:65px;font-size:12px}
...
.overlay{position:fixed;inset:0;background:rgba(0,0,0,.7);display:flex;align-items:center;
  justify-content:center;z-index:200;animation:fadeIn .2s ease}
.modal{background:var(--surface);border:1px solid var(--border);border-radius:12px;
  width:90%;max-width:400px;padding:28px 24px;display:flex;flex-direction:column;
  align-items:center;gap:16px;animation:slideUp .3s ease}
.modal h2{font-family:'Bebas Neue',sans-serif;font-size:28px;letter-spacing:2px}
.modal p{font-size:14px;color:var(--muted);text-align:center;line-height:1.5}
.modal-word{font-family:'Bebas Neue',sans-serif;font-size:22px;letter-spacing:3px;color:var(--correct)}
...
.stat-num{font-family:'Bebas Neue',sans-serif;font-size:32px}
...
.dist-bar{height:20px;min-width:20px;background:var(--absent);border-radius:3px;
  display:flex;align-items:center;justify-content:flex-end;padding-right:6px;
  font-size:12px;font-weight:700;transition:width .5s ease}
.dist-bar.current{background:var(--correct)}
.btn{padding:12px 24px;border-radius:6px;border:none;font-family:'Inter',sans-serif;
  font-weight:700;font-size:14px;cursor:pointer;transition:opacity .2s,transform .1s}
.btn:active{transform:scale(.97)}
.btn-primary{background:var(--correct);color:#fff}
.btn-secondary{background:var(--border);color:var(--text)}
.btn-row{display:flex;gap:10px;flex-wrap:wrap;justify-content:center}
.share-box{background:var(--bg);border-radius:8px;padding:12px 16px;
...
.tutorial-examples{display:flex;flex-direction:column;gap:12px;width:100%}
.tutorial-row{display:flex;gap:5px;justify-content:center}
.tutorial-cell{width:48px;height:48px;display:flex;align-items:center;justify-content:center;
  font-family:'Bebas Neue',sans-serif;font-size:26px;border:2px solid var(--border);border-radius:3px;}
...
.archive-wrap{display:flex;flex-wrap:wrap;gap:6px;max-height:200px;overflow-y:auto;padding:4px}
.chip{padding:6px 10px;border-radius:20px;font-size:12px;font-weight:600;
  cursor:pointer;border:none;background:var(--border);color:var(--text);transition:background .2s}
...
@media(max-width:400px){
  ...
  .kb-key{height:50px;min-width:33px;max-width:33px;font-size:11px}
...
const KB_ROWS=[["Q","W","E","R","T","Y","U","I","O","P"],["A","S","D","F","G","H","J","K","L"],["INVIO","Z","X","C","V","B","N","M","⌫"]];
      ...
      {KB_ROWS.map((row,ri)=>(
        <div className="kb-row" key={ri}>
          {row.map(k=>{
            ...
            return <button key={k} className={`kb-key${k.length>1?" wide":""}${st?` kb-${st}`:""}`} onClick={()=>onKey(k)}>{k}</button>;
          })}
        </div>
      ))}
    </div>
...
export default function App() {
  ...
  const [guesses,setGuesses]=useState([]); // [{word,result}] — già animate
  ...
  // Lettera stati tastiera: include anche la riga in flip
  const letterStates=(()=>{
    const map={};
  ...
  // Animazione flip in 2 fasi
  function runFlip(newGuess, onDone) {
    const COL_DELAY=0.1; // secondi per colonna (uguale al CSS)
    const PHASE_MS=(5*COL_DELAY+0.15)*1000; // 5 colonne × 100ms + durata animazione
  ...
  const submitGuess=useCallback(()=>{
    ...
    if(hardMode&&guessesRef.current.length>0){
      ...
      const pNeeded=last.word.split("").filter((_,i)=>last.result[i]==="present");
      for(const l of pNeeded){
  ...
  function renderRows(){
    ...
    for(let r=0;r<MAX_GUESSES;r++){
      if(r<guesses.length){
        ...
        rows.push(
          <div className="board-row" key={r}>
            {g.word.split("").map((l,i)=>(
              <div key={i} className="cell revealed" style={{"--status":statusColor(g.result[i])}}>
        ...
        // Riga in animazione flip
        rows.push(
          <div className="board-row" key={r}>
            {flipping.word.split("").map((l,i)=>(
              <div key={i} className={`cell flip-${flipping.phase}`}
                style={{"--col":i,"--status":statusColor(flipping.result[i])}}>
                <div className="cell-face">{l}</div>
              </div>
            ))}
          </div>
            ...
            {[1,2,3,4,5,6].map(n=>(
              <div className="dist-row" key={n}>
                ...
                <div className={`dist-bar${guesses.length===n&&won?" current":""}`}
                  style={{width:`${Math.max(20,(stats.dist[n]||0)/maxBar*180)}px`}}>
                  {stats.dist[n]||0}
                </div>
              </div>
            ))}
      ...
      <div className="overlay" onClick={()=>setModal(null)}>
        <div className="modal" onClick={e=>e.stopPropagation()}>
          ...
          <div className="tutorial-examples">
            <p style={{fontSize:"13px",color:"var(--muted)"}}>🟩 Lettera corretta nella posizione giusta</p>
            <div className="tutorial-row">
              {["P","I","A","N","O"].map((l,i)=>(
                <div key={i} className={`tutorial-cell${i===0?" correct":""}`}>{l}</div>
              ))}
            </div>
            <p style={{fontSize:"13px",color:"var(--muted)"}}>🟨 Lettera presente ma in posizione sbagliata</p>
            <div className="tutorial-row">
              {["F","I","U","M","E"].map((l,i)=>(
                <div key={i} className={`tutorial-cell${i===2?" present":""}`}>{l}</div>
              ))}
            </div>
            <p style={{fontSize:"13px",color:"var(--muted)"}}>⬛ Lettera non presente nella parola</p>
            <div className="tutorial-row">
              {["V","E","N","T","O"].map((l,i)=>(
  ...
  return(
    <>
      <style>{STYLES}</style>
      <div style={{width:"100%",maxWidth:"500px",display:"flex",flexDirection:"column",minHeight:"100vh"}}>
        <header className="header">
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2}}>
            ...
            <span className="wordle-num">#{wordNum} • {POOL_SIZE} parole</span>
          </div>
